...
from .views import (
    pwmanager, index, task, accounts, statistic, permissions, contents, config, assigns, fund
)
...
urlpatterns = [
    ...
    url(r'^label_manage/$', assigns.LabelManage.as_view(), name='label_manage'),
    ...
    url(r'^group_manage/$', assigns.GroupManage.as_view(), name='group_manage'),
    url(r'^live_online/$', assigns.LiveOnline.as_view(), name='live_online'),
    url(r'^live_hide/$', assigns.LiveHide.as_view(), name='live_hide'),
    url(r'^live_search/$', assigns.LiveSearch.as_view(), name='live_search'),
    url(r'^live_special/$', assigns.LiveSpecial.as_view(), name='live_special'),
    url(r'^cover_verify/$', assigns.CoverVerify.as_view(), name='cover_verify'),
    url(r'^live_product/$', assigns.LiveProduct.as_view(), name='live_product'),
    url(r'^live_room_report/$', assigns.LiveRoomReport.as_view(), name='live_room_report'),
    url(r'^live_gift_report/$', assigns.LiveGiftReport.as_view(), name='live_gift_report'),
    url(r'^live_drama_report/$', assigns.LiveDramaReport.as_view(), name='live_drama_report'),
    url(r'^live_gift_income/$', assigns.LiveGiftIncome.as_view(), name='live_gift_income'),
    url(r'^label_rank_list/$', assigns.LabelRankList.as_view(), name='label_rank_list'),
    url(r'^sociaty_list/$', assigns.SociatyList.as_view(), name='sociaty_list'),
    url(r'^sociaty_leaguer_list/$', assigns.SociatyLeaguerList.as_view(), name='sociaty_leaguer_list'),
]
