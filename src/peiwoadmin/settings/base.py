"""
Django settings for peiwoadmin project.
...
SECRET_KEY = '+h=6u7mrq*4z!+5&(71=(bdd%80y+g98y!j#iwe(l$dr_1&q=d'
...
WSGI_APPLICATION = 'peiwoadmin.wsgi.application'
...
LOGIN_URL = reverse_lazy('pwadmin:sign-in')
LOGIN_REDIRECT_URL = reverse_lazy('pwadmin:home')
